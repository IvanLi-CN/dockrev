...
| 0014 | CI/CD: Release workflow 成功后自动清理 Actions Artifacts | 部分完成（2/3） | `0014:cleanup-actions-artifacts/PLAN.md` | 2026-01-27 | PR #32；待验证：需要一次 `should_release=true` 的 Release run（成功/失败路径各一次） |
