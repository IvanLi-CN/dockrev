...
|-----:|-------|--------|------|------|-------|
| myy3w | Dockrev：Settings 空 Public Base URL 当前地址建议气泡 | 已完成 | `myy3w-settings-public-base-url-suggest/SPEC.md` | 2026-03-07 | fast-track（origin 建议气泡 + localStorage 拒绝偏好 + storybook 覆盖，PR #145） |
