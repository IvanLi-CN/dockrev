...
| 5umc8 | Dockrev：发现次数气泡改为版本时间线 | 已完成 | `5umc8-discovery-count-timeline/SPEC.md` | 2026-03-21 | fast-track（runtime startedAt 真相源 + discovery timeline lazy API + shared hover-pin popover） |
