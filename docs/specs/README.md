...
|-----:|-------|--------|------|------|-------|
| r8kpa | Dockrev：Web PWA 离线壳、更新提示与分级缓存 | 部分完成（4/6） | `r8kpa-web-pwa-offline-shell/SPEC.md` | 2026-07-08 | fast-track（PWA shell + update prompt + readonly snapshot cache；service detail offline subpages 与 full Storybook smoke 仍待收口） |
