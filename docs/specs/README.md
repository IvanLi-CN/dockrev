...
| tvat2 | Dockrev：修复 Update Job 回滚后的 digest 摘要与健康进度误报 | 部分完成（4/5） | `tvat2-update-job-rollback-digest-contract/SPEC.md` | 2026-03-25 | fast-track（PR #183；backend contract + tests + storybook rollback evidence；checks pending） |
