...
| 5umc8 | Dockrev：发现次数气泡改为版本时间线 | 已完成 | `5umc8-discovery-count-timeline/SPEC.md` | 2026-03-22 | fast-track（runtime startedAt 真相源 + discovery timeline lazy API + shared hover-pin popover；PR #176 restores count/timeline parity for repeated unresolved alias history） |
