...
| qnq3w | Dockrev：Release Publication 对齐 latest 与 PR 发版评论 | 部分完成（4/5） | `qnq3w-release-publication-latest-pr-comment/SPEC.md` | 2026-03-28 | fast-track（publication ledger + PR release-version issue comment + self-test/README sync；supersedes #48mh8 comment non-goal） |
