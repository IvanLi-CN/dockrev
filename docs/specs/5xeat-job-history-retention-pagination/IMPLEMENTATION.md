...
- Resource GC runs after startup and then once per minute, deleting at most ten 10,000-row batches and yielding between batches; terminal job GC remains bounded. SQLite page reclamation remains a separate operator maintenance action.
