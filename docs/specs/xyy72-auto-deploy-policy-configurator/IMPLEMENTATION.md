...
- 已实现 Service Detail 与 Stack Detail 的最终策略结果摘要、最近三次更新记录，以及独立响应式设置抽屉；桌面从右侧出现，移动端从底部出现。
...
- Web: Service/Stack policy editor drawer, detail summary cards, recent update records, Stack detail page, route entry, client types, mock API, Storybook states.
