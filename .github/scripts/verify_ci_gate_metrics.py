...
def verify(metrics: list[dict[str, Any]], expected_count: int = 10) -> dict[str, float]:
    ...
    for item in metrics:
        ...
        durations = [item.get(key) for key in ("queue_seconds", "fast_seconds", "source_seconds", "eligibility_seconds", "execution_seconds")]
        ...
        if run_started < created or fast_completed < run_started or source_completed < run_started:
        ...
        expected_durations = {
            ...
            "fast_seconds": (fast_completed - run_started).total_seconds(),
            "source_seconds": (source_completed - run_started).total_seconds(),
            "eligibility_seconds": (eligibility_completed - run_started).total_seconds(),
            "execution_seconds": (eligibility_completed - run_started).total_seconds(),
        }
