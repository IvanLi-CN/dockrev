...
import { ApiError, archiveService, createIgnore, getServiceBackupRecords, getServiceBackupTargets, getServiceLifecycleStatus, getServiceRollbackTarget, getServiceSettings, getStack, getStackSettings, listIgnores, previewServiceVersionUpdate, restoreService, triggerServiceLifecycle, triggerServiceRollback, triggerServiceVersionUpdate, triggerUpdate, type IgnoreRule, type Service, type ServiceBackupRecordItem, type ServiceBackupTargetsResponse, type ServiceLifecycleAction, type ServiceLifecycleStatusResponse, type ServiceRollbackTargetResponse, type ServiceSettings, type StackDetail, type StackSettings } from '../api'
...
export function useServiceDetailPageState(props: {
  ...
  const requestApplyVersion = useCallback((releaseTag: string) => {
    void (async () => {
      const generation = pageGeneration
